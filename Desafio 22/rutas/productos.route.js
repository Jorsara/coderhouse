...
switch (persistencia){
    case 1: {
        const { listar, vista, listarId, agregar, actualizar, borrar, buscarNombre, buscarCodigo, buscarPrecio, buscarStock, vistaTest } = require('../controllers/mongoDB/productos');

        // Test de mock de datos
        router.get('/vista-test', vistaTest);
