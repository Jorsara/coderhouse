...
let json = new PrimeraConexion().obtenerProductos();
...
const buscarNombre = async ( req, res, next ) => {       
  try{
    // Buscar el producto y mostrarlo
    const result = json.filter(product => product.title == req.query.title);
...
const buscarCodigo = async ( req, res, next ) => {       
  try{
    // Buscar el producto y mostrarlo
    const result = json.filter(product => product.codigo == req.query.codigo);
...
const buscarPrecio = async ( req, res, next ) => {       
  try{
    // Buscar el producto y mostrarlo
    const result = json.filter(product => product.price == req.query.minimo);
...
const buscarStock = async ( req, res, next ) => {       
  try{
    // Buscar el producto y mostrarlo
    const result = json.filter(product => product.stock == req.query.minimo);
