...
router.post('/login', passport.authenticate('login',{failureRedirect:'/user/error-login'}), loginPost);
router.post('/register', passport.authenticate('register',{failureRedirect:'/user/error-register'}), registerPost);
